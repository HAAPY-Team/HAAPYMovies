 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint = 
		  ...
		  Person2 p2 = new Person2("Henry Leung");
		  toPrint += p2.toString("hleung7");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Yuanhan Pan");
		  toPrint += p3.toString("ypan75");
                  ...
                  Person5 p5 = new Person5("Patrick Tam");
                  toPrint += p5.toString("ptam7");
